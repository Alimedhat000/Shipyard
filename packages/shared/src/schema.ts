...
export const buildJobs = pgTable('build_jobs', {
  ...
  deploymentIdIdx: index('idx_build_jobs_deployment_id').on(table.deploymentId),
}));
...
export const deploymentLogs = pgTable('deployment_logs', {
  ...
  deploymentIdIdx: index('idx_deployment_logs_deployment_id').on(table.deploymentId),
}));
...
export const deploymentFiles = pgTable('deployment_files', {
  ...
  deploymentIdIdx: index('idx_deployment_files_deployment_id').on(table.deploymentId),
}));
